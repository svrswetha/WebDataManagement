...
else
{
 $sql = "SELECT * FROM users WHERE email='$email'";
    ...
    $query4= "INSERT INTO service (fname,lname,phone,email,userid) VALUES ('$fname','$lname','$phone','$email','$row2[0]') ";
...
<tr><td>Business Name:</td><td><input type="text" name="businessname" value=""></td></tr>
