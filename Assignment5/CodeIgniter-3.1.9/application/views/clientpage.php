...
<table class="table">
<tr><td>Client name:</td><td><input type="text" name="cname" value=""></td></tr>
<tr><td>*My Pet:</td><td><input type="text" name="pet" value=""></td></tr>
<tr><td><input type="submit" value="Add New One"></td><td></td></tr>
</table>
</form> 
<footer>
